...
private:
    ...
    void choose_palette_start_color();
    ...
    QGroupBox* text_group_{};
    QLineEdit* text_value_{};
    ...
    QDoubleSpinBox* transform_scale_x_{};
    ...
    QCheckBox* palette_enabled_{};
    QComboBox* palette_scope_{};
    QComboBox* palette_target_{};
    ColorPreviewButton* palette_start_color_button_{};
    QListWidget* palette_colors_{};
    QSpinBox* palette_offset_{};
    QDoubleSpinBox* palette_hue_step_{};
    QPushButton* palette_add_{};
    QPushButton* palette_edit_{};
